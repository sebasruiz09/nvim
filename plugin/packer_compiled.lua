...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-prettier', 'ale'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType vue ++once lua require("packer.load")({'vim-prettier'}, { ft = "vue" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'vim-prettier', 'ale'}, { ft = "html" }, _G.packer_plugins)]]
